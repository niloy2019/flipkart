...
//This Servlet will Increase the Amount of Product present in the cart
...
public class IncreaseQuantity extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//Increasing the Quantity of the Product in the Cart by calling increaseQuantity()
		cartDaoImpl.increaseQuantity(productId, customerId);
